...
class DeleteChatsWithDeletedCharactersCall {
  static Future<ApiCallResponse> call({
    String? userId = '',
  }) async {
    final ffApiRequestBody = '''
{
  "userId": "$userId"
    ...
    return ApiManager.instance.makeApiCall(
      callName: 'deleteChatsWithDeletedCharacters',
      apiUrl:
          'https://us-central1-rasondo-v3-wpjwei.cloudfunctions.net/deleteInvalidChats',
      callType: ApiCallType.POST,
      headers: {
        'Content-Type': 'application/json',
      },
