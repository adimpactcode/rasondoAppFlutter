...
export 'generated_image_model.dart';

class GeneratedImageWidget extends StatefulWidget {
  const GeneratedImageWidget({super.key});
...
class _GeneratedImageWidgetState extends State<GeneratedImageWidget> {
  late GeneratedImageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GeneratedImageModel());
