...
class BottomSheetEmailSentWidget extends StatefulWidget {
  const BottomSheetEmailSentWidget({super.key});

  @override
  State<BottomSheetEmailSentWidget> createState() =>
      _BottomSheetEmailSentWidgetState();
}

class _BottomSheetEmailSentWidgetState
    extends State<BottomSheetEmailSentWidget> {
  late BottomSheetEmailSentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomSheetEmailSentModel());
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'BOTTOM_SHEET_EMAIL_SENT_CREATE_NOTE_BTN_');
                        logFirebaseEvent('Button_navigate_back');
                        context.pop();
                      },
                      text: FFLocalizations.of(context).getText(
                        'me1io4ik' /* Create Note */,
                      ),
