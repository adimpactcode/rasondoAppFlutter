...
class _Auth2CreateWidgetState extends State<Auth2CreateWidget> {
  ...
  void initState() {
    ...
    _model.passwortBestaetigenTextController ??= TextEditingController();
    _model.passwortBestaetigenFocusNode ??= FocusNode();
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'fy0qts70' /* Kostenlos registrieren */,
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'cd1yosg1' /* Erstelle dein Profil und start... */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .passwortBestaetigenTextController,
                                        focusNode:
                                            _model.passwortBestaetigenFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.password],
                                        obscureText: !_model
                                            .passwortBestaetigenVisibility,
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            'cx7u0lr7' /* Password */,
                                          ...
                                          suffixIcon: InkWell(
                                            ...
                                            focusNode:
                                                FocusNode(skipTraversal: true),
                                            child: Icon(
                                              _model.passwortBestaetigenVisibility
                                                  ? Icons.visibility_outlined
                                                  : Icons
                                                      .visibility_off_outlined,
                                              color:
