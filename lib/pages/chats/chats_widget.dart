...
class _ChatsWidgetState extends State<ChatsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultpl9 = await DeleteChatsWithDeletedCharactersCall.call(
        userId: currentUserUid,
      );

      if ((_model.apiResultpl9?.succeeded ?? true)) {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CharactersMainRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CharactersMainRecord> chatsCharactersMainRecordList =
            snapshot.data!;
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Visibility(
                                        visible: chatsCharactersMainRecordList.isNotEmpty,
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 5.0, 0.0, 30.0),
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Visibility(
                                            visible:
                                                chatsCharactersMainRecordList.isEmpty,
                                            child: Row(
                                              mainAxisSize: MainAxisSize.max,
                                              mainAxisAlignment:
                                                ...
                                                Flexible(
                                                  child: FFButtonWidget(
                                                    ...
                                                    text: FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'fho1dj62' /* Jetzt Catpartner entdecken! */,
                                                    ),
                                                    options: FFButtonOptions(
                                                      height: 40.0,
                                                      padding:
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return Padding(
                                        ...
                                        child:
                                          ...
                                          stream:
                                              CharactersMainRecord.getDocument(
                                                  listViewChatsRecord
                                                      .characterId!),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            ...
                                            final containerCharactersMainRecord =
                                                snapshot.data!;
