...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDE5499);
  ...
  late Color primaryText = const Color(0xF3040404);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFF2F2F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFDE5499);
  late Color accent2 = const Color(0xFF646B73);
  late Color accent3 = const Color(0xFFFF6F61);
  late Color accent4 = const Color(0xFFD1A3FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC6408C);
